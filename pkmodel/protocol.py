...
class Protocol:
    ...
    :param dose_on: int number of time units (thousandths of an hour)
        for which drug is administered at a time (dose_on = 0 -> single dose at time 0)
    ...
    :optional param graph_preview: bool to trigger graph preview of dosing function (default value False -> preview not shown)

    :method dose: takes parameters t, X and returns X or 0, depending on value of t.
        Represents a variable dose function over time.
    """
